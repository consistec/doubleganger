package de.consistec.doubleganger.impl.adapter.it_mysql;
...
public class MySqlDatabase extends TestDatabase {
    ...
    public MySqlDatabase(DatabaseAdapterFactory.AdapterPurpose side) {
        super(CONFIG_FILE, DummyDataSource.SupportedDatabases.MYSQL, side);
    }
}
