...
public class SynchronizationIT {
    ...
    @Test
    public void testServerPostgresOffClientPostgresOff() throws SyncException, ContextException, SQLException, IOException {
        init(POSTGRESQL, false, POSTGRESQL, false);
        testWithDataBeforeFirstSync();
    }

    @Test
    public void testServerPostgresOnClientPostgresOn() throws SyncException, ContextException, SQLException, IOException {
    ...
    @Test
    public void testServerPostgresOnClientSqliteOff() throws SyncException, ContextException, SQLException, IOException {
    ...
    public void init(DummyDataSource.SupportedDatabases serverDbType, boolean serverTriggers,
        DummyDataSource.SupportedDatabases clientDbType, boolean clientTriggers) throws SyncException, ContextException,
    ...
    public IConflictListener getServerConflictResolver() {
        return new IConflictListener() {
            ...
            public ResolvedChange resolve(Map<String, Object> serverData, Map<String, Object> clientData) {
                ResolvedChange resolvedChange = new ResolvedChange(UserDecision.SERVER_CHANGE);
