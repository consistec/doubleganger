...
public enum SyncAction {
    ...
    /**
     * Corresponds with {@link de.consistec.doubleganger.common.server.IServerSyncProvider#getSchema() } method of
     * server provider.
     */
    GET_SCHEMA("getschema"),
    /**
     * Corresponds with {@link de.consistec.doubleganger.common.server.IServerSyncProvider#getChanges(int) } method of
     * server provider.
     */
    GET_CHANGES("getchanges"),
    /**
     * Corresponds with
     * {@link de.consistec.doubleganger.common.server.IServerSyncProvider#applyChanges(java.util.List, int) }
     * method of
     * server provider.
     */
    ...
    /**
     * Corresponds with
     * {@link de.consistec.doubleganger.common.server.IServerSyncProvider#validate(
     *de.consistec.doubleganger.common.SyncSettings)}
     * method of
     * server provider.
     */
