 ...
 * <p>
 * Do not use directly! Instead, use {@link de.consistec.doubleganger.common.SyncContext.client()}
 * factory methods to obtain client context and performs client site operations.
 * </p>
 * <p>
 * This class is used by the {@link de.consistec.doubleganger.common.SyncContext.ClientContext} to carry out
...
public class SyncAgent {
     ...
     * @see IClientSyncProvider#setConflictListener(de.consistec.doubleganger.common.IConflictListener)
     */
     ...
     * {@link de.consistec.doubleganger.common.ISyncProgressListener#progressUpdate(java.lang.String) }
     ...
     * It invokes on all progress listeners
     * {@link de.consistec.doubleganger.common.ISyncProgressListener#syncFinished() } method.
     */
