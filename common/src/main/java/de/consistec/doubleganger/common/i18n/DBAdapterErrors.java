 ...
 */
@BaseName("de/consistec/doubleganger/common/i18n/db_adapters_errors")
@LocaleData(value = {
    @Locale("en") })
public enum DBAdapterErrors {
     ...
     * {@link de.consistec.doubleganger.common.data.schema.Schema schema} to SQL script.
     */
    ...
    CANT_GET_ALL_ROWS,
    /**
     * When building the {@link de.consistec.doubleganger.common.data.schema.Schema Schema} fails.
     */
    CANT_BUILD_SCHEMA,
    /**
