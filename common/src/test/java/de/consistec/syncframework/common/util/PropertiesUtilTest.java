...
public class PropertiesUtilTest extends TestBase {
    ...
    public void testReadClass() throws NoSuchMethodException, Exception {
        ...
        assertEquals("Expected and returned Class are different", getClass(), PropertiesUtil.readClass(props, propsName, true));
        assertNull("Reading nonexisting and optional value should return NULL", PropertiesUtil.readClass(new Properties(), propsName, false));
        try {
            PropertiesUtil.readClass(new Properties(), propsName, true);
        } catch (Throwable e) {
            assertEquals("Reading value from Properties object when corresponding value does not exists should throw " + ConfigException.class.getSimpleName(), ConfigException.class, e.getClass());
        }
    }
     ...
     */
    @Test
    public void testReadEnum() throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, IllegalArgumentException, InstantiationException, InvocationTargetException {

        Properties props = new Properties();
        String propsName = "enum";
        ConflictStrategy enumValue = ConflictStrategy.CLIENT_WINS;
        props.put(propsName, enumValue.name());
        assertEquals("Expected and returned enumeration values are different", enumValue, PropertiesUtil.readEnum(props, propsName, true, ConflictStrategy.class));
        assertNull("Reading nonexisting and optional value should return NULL", PropertiesUtil.readEnum(new Properties(), propsName, false, ConflictStrategy.class));
        try {
    ...
    public void testReadCollection() throws Exception {
        ...
        String el2 = "element2";
        String el3 = "element3";
        String collectionAsString = el1 + Config.DELIMITER + el2 + Config.DELIMITER + el3;
        ArrayList<String> expected = new ArrayList<String>(3);
        expected.add(el1);
        expected.add(el2);
        expected.add(el3);
        props.put(propsName, collectionAsString);
        assertEquals("Expected and returned collection are different", expected, PropertiesUtil.readCollection(props, propsName, true, ArrayList.class));
        assertNull("Reading nonexisting and optional value should return NULL", PropertiesUtil.readCollection(new Properties(), propsName, false, ArrayList.class));
        try {
    ...
    public void testReadNumber() throws Exception {
        ...
        assertEquals("Expected and returned Byte value are different", byteVal, PropertiesUtil.readNumber(props, propsName, true, Byte.class));
        props.put(propsName, String.valueOf(shortVal));
        assertEquals("Expected and returned Short value are different", shortVal, PropertiesUtil.readNumber(props, propsName, true, Short.class));
        props.put(propsName, String.valueOf(integerVal));
        assertEquals("Expected and returned Integer value are different", integerVal, PropertiesUtil.readNumber(props, propsName, true, Integer.class));
        props.put(propsName, String.valueOf(longVal));
        assertEquals("Expected and returned Long value are different", longVal, PropertiesUtil.readNumber(props, propsName, true, Long.class));
        props.put(propsName, String.valueOf(floatVal));
        assertEquals("Expected and returned Float value are different", floatVal, PropertiesUtil.readNumber(props, propsName, true, Float.class));
        props.put(propsName, String.valueOf(doubleVal));
        assertEquals("Expected and returned Double value are different", doubleVal, PropertiesUtil.readNumber(props, propsName, true, Double.class));
        props.put(propsName, String.valueOf(bigIntegerVal));
        assertEquals("Expected and returned BigInteger value are different", bigIntegerVal, PropertiesUtil.readNumber(props, propsName, true, BigInteger.class));
        props.put(propsName, String.valueOf(bigDecimalVal));
        assertEquals("Expected and returned BigDecimal value are different", bigDecimalVal, PropertiesUtil.readNumber(props, propsName, true, BigDecimal.class));
        assertNull("Reading nonexisting and optional value should return NULL", PropertiesUtil.readNumber(new Properties(), propsName, false, Integer.class));
        try {
